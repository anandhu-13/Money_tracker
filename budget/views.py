...
# url: localhost:8000/transactions/details/
# method: get
...
# transaction update
# url: localhost:8000/transactions/{id}}/edit/
# method get,post
...
class SignUpView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            ...
            User.objects.create_user(**form.cleaned_data)       # quary for password encrypting
